...
import { type CourseRoutine } from "../types/interfaces";
...
function AddRoutineForm({
  ...
  courseNo: number;
  getRoutine: (courseRoutine: CourseRoutine) => void;
}) {
  const Course: string[] = ["Course 1", "Course 2", "Course 3", "Course 4"];
  const Days: CourseRoutine["courseDay"][] = [
    "SAT-MON",
    "SUN-TUE",
    "MON-WED",
    "TUE-THU",
  ...
  const Slots: CourseRoutine["courseSlot"][] = [
    "08:00-09:20",
    "09:30-10:50",
    "11:00-12:20",
    "12:30-01:50",
  ...
  const Day: CourseRoutine["labDay"][] = [
    "SAT",
    "SUN",
    "MON",
    "TUE",
  ...
  const LabSlots: CourseRoutine["labTime"][] = [
    "08:00-10:50",
    "11:00-01:50",
    "02:00-04:50",
  ];
  ...
  const [labTime, setLabTime] =
    useState<CourseRoutine["labTime"]>("08:00-10:50");
        ...
        <div className="flex">
          <div className=" flex-col w-1/2 mr-0.5">
            ...
            <select
              ...
              value={day}
              onChange={(e) =>
                setDay(e.target.value as CourseRoutine["courseDay"])
              }
          ...
          <div className=" flex-col w-1/2 ml-0.5">
            ...
            <select
              ...
              value={time}
              onChange={(e) =>
                setTime(e.target.value as CourseRoutine["courseSlot"])
              }
              className=" w-full border border-gray-300 rounded-lg px-4 py-2 bg-white text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
          ...
          <div className=" flex">
            <div className=" flex-col w-1/2 mr-0.5">
              ...
              <select
                ...
                value={labDay}
                onChange={(e) =>
                  setLabDay(e.target.value as CourseRoutine["labDay"])
                }
                className=" w-full border border-gray-300 rounded-lg px-4 py-2 bg-white text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
                {Day.map((day, index) => (
            ...
            <div className=" flex-col w-1/2 ml-0.5">
              ...
              <select
                ...
                value={labTime}
                onChange={(e) =>
                  setLabTime(e.target.value as CourseRoutine["labTime"])
                }
                className=" w-full border border-gray-300 rounded-lg px-4 py-2 bg-white text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
